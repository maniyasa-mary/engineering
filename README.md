...
Всего в опросе приняли участие 110 человек. Сбор данных происходил вручную, скачиванием JSON файла с данными опроса.
...
- При ответе на вопрос №2 "Придерживаетесь ли Вы ЗОЖ" - "Да" - должен быть заполнен блок №3; 
