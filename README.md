...
Создана презентация, в которой описаны шаги, упоминаемые в этом документе, а также визуальные дополнения к шагам и дашборды с результатами опроса. PDF файл прикреплен в данном репозитории.
